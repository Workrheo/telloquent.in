    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('architect_description', models.TextField(blank=True, null=True)),
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='architect_user', to=settings.AUTH_USER_MODEL)),
                ('user_profile', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='architect_userprofile', to='accounts.userprofile')),
            ],
        ),
        migrations.CreateModel(
            name='Architect_ProjectImages',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(blank=True, null=True, upload_to='projectimages/')),
                ('architect', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='architects.architect')),
            ],
            options={
